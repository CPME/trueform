...
export const IR_SCHEMA = {
  ...
  $defs: {
    ...
    RibThicknessSide: { enum: RIB_THICKNESS_SIDES },
    ...
    Rib: {
      type: "object",
      required: ["id", "kind", "profile", "thickness", "depth", "result"],
      properties: {
        id: { $ref: "#/$defs/ID" },
        kind: { const: "feature.rib" },
        deps: { type: "array", items: { $ref: "#/$defs/ID" } },
        tags: { type: "array", items: { type: "string" } },
        profile: { $ref: "#/$defs/ProfileRef" },
        ...
        result: { type: "string" },
        axis: { $ref: "#/$defs/ExtrudeAxis" },
        side: { $ref: "#/$defs/RibThicknessSide" },
      },
      additionalProperties: false,
    },
    Web: {
