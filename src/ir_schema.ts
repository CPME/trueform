...
export const IR_SCHEMA = {
  ...
  $defs: {
    ...
    LengthUnit: { enum: LENGTH_UNITS },
    AngleUnit: { enum: ANGLE_UNITS },
    Unit: { enum: UNITS },
    Units: { enum: LENGTH_UNITS },
    AxisDirection: { enum: AXIS_DIRECTIONS },
    ParamType: { enum: PARAM_TYPES },
    ...
    ExtrudeMode: { enum: EXTRUDE_MODES },
    UnwrapMode: { enum: UNWRAP_MODES },
    SweepOrientation: { enum: SWEEP_ORIENTATIONS },
    ThickenDirection: { enum: THICKEN_DIRECTIONS },
    ThreadHandedness: { enum: THREAD_HANDEDNESS },
    HoleEndCondition: { enum: HOLE_END_CONDITIONS },
    PointLocator: { enum: POINT_LOCATORS },
    ...
    SketchConstraintParallel: {
      ...
      properties: {
        id: { $ref: "#/$defs/ID" },
        kind: { const: "sketch.constraint.parallel" },
        a: { $ref: "#/$defs/ID" },
        b: { $ref: "#/$defs/ID" },
      },
      additionalProperties: false,
    ...
    SketchConstraintPerpendicular: {
      ...
      properties: {
        id: { $ref: "#/$defs/ID" },
        kind: { const: "sketch.constraint.perpendicular" },
        a: { $ref: "#/$defs/ID" },
        b: { $ref: "#/$defs/ID" },
      },
      additionalProperties: false,
    ...
    SketchConstraintEqualLength: {
      ...
      properties: {
        id: { $ref: "#/$defs/ID" },
        kind: { const: "sketch.constraint.equalLength" },
        a: { $ref: "#/$defs/ID" },
        b: { $ref: "#/$defs/ID" },
      },
      additionalProperties: false,
    ...
    Path3DHelix: {
      type: "object",
      required: ["kind", "origin", "axis", "radius", "pitch"],
      properties: {
        kind: { const: "path.helix" },
        origin: { $ref: "#/$defs/Point3D" },
        axis: { $ref: "#/$defs/Point3D" },
        radius: { $ref: "#/$defs/Scalar" },
        pitch: { $ref: "#/$defs/Scalar" },
        turns: { $ref: "#/$defs/Scalar" },
        length: { $ref: "#/$defs/Scalar" },
        handedness: { $ref: "#/$defs/ThreadHandedness" },
        startAngle: { $ref: "#/$defs/Scalar" },
    ...
    Path3DSpiral: {
      type: "object",
      required: ["kind", "origin", "startRadius", "endRadius", "turns"],
      properties: {
        kind: { const: "path.spiral" },
        origin: { $ref: "#/$defs/Point3D" },
        normal: { $ref: "#/$defs/Point3D" },
        xDir: { $ref: "#/$defs/Point3D" },
        startRadius: { $ref: "#/$defs/Scalar" },
        endRadius: { $ref: "#/$defs/Scalar" },
        turns: { $ref: "#/$defs/Scalar" },
        handedness: { $ref: "#/$defs/ThreadHandedness" },
        startAngle: { $ref: "#/$defs/Scalar" },
        segmentsPerTurn: { $ref: "#/$defs/Scalar" },
    ...
    DatumModifier: { enum: DATUM_MODIFIERS },
    ToleranceModifier: {
      enum: TOLERANCE_MODIFIERS,
    },
    ...
    Shell: {
      ...
      properties: {
        ...
        direction: { enum: TRIM_SURFACE_KEEPS.slice(0, 2) },
    ...
    TrimSurface: {
      type: "object",
      required: ["id", "kind", "source", "tools", "keep", "result"],
      properties: {
        id: { $ref: "#/$defs/ID" },
        kind: { const: "feature.trim.surface" },
        deps: { type: "array", items: { $ref: "#/$defs/ID" } },
        tags: { type: "array", items: { type: "string" } },
        source: { $ref: "#/$defs/Selector" },
        tools: {
        ...
        keep: { enum: TRIM_SURFACE_KEEPS },
        result: { type: "string" },
      },
      additionalProperties: false,
    },
    ExtendSurfaceMode: { enum: EXTEND_SURFACE_MODES },
    ExtendSurface: {
      type: "object",
      required: ["id", "kind", "source", "edges", "distance", "result"],
      properties: {
        id: { $ref: "#/$defs/ID" },
        kind: { const: "feature.extend.surface" },
        deps: { type: "array", items: { $ref: "#/$defs/ID" } },
        tags: { type: "array", items: { type: "string" } },
        source: { $ref: "#/$defs/Selector" },
        edges: { $ref: "#/$defs/Selector" },
        distance: { $ref: "#/$defs/Scalar" },
        mode: { $ref: "#/$defs/ExtendSurfaceMode" },
        result: { type: "string" },
      },
      additionalProperties: false,
    },
    Knit: {
      type: "object",
      required: ["id", "kind", "sources", "result"],
      properties: {
        id: { $ref: "#/$defs/ID" },
        kind: { const: "feature.knit" },
        deps: { type: "array", items: { $ref: "#/$defs/ID" } },
        tags: { type: "array", items: { type: "string" } },
        sources: {
          type: "array",
