...
| Multi-body direct edits | Delete/replace/move face, move/copy body | `staging` | `feature.move.body` and `feature.move.face` are now ready; `feature.delete.face` and `feature.replace.face` remain in staging. |
